...
public class MusicGlobalHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorResponse> exceptionHandler(SoundNotFoundException e){
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ErrorResponse(e.getMessage()));
    }

    @ExceptionHandler
    public ResponseEntity<ErrorResponse> exceptionHandler(LikeNotFoundException e){
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ErrorResponse(e.getMessage()));
    }
}
