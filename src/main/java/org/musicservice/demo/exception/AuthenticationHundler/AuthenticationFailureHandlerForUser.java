package org.musicservice.demo.exception.AuthenticationHundler;
...
@Component
public class AuthenticationFailureHandlerForUser implements AuthenticationFailureHandler {

    private final UserRepository repository;
    private Map<String, String> error;

    @Autowired
    public AuthenticationFailureHandlerForUser(UserRepository repository) {
